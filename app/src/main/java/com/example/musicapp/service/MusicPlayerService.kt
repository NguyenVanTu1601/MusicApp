...
class MusicPlayerService : Service() {
    ...
    private var musicNotification = MusicNotification(this)
    ...
    fun play() {
        ...
        musicNotification.changeIconNotification(Constants.PLAY_PAUSE)
    }

    fun pause() {
        mediaPlayer.pause()
        musicNotification.changeIconNotification(Constants.PAUSE)
    }
